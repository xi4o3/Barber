...
import com.example.barber.Common.Common;
import com.example.barber.Fragments.HomeFragment;
import com.example.barber.Fragments.ShopingFragment;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //If login = false, just let user shopping around to view
        if (getIntent() != null)
        {
            ...
            if (isLogin)
            {
                ...
                AccountKit.getCurrentAccount(new AccountKitCallback<Account>() {
                    ...
                    public void onSuccess(final Account account) {
                        if (account != null)
                        {
                            DocumentReference currentUser = userRef.document(account.getEmail().toString());
                            currentUser.get()
